...
#
# Generated: 2015-11-18 22:02:52.185
...
ptf=e:\MyProject\My_project\Altera\Q11MultiCore\software\ucosCPU0_syslib\..\..\Nios2Core2.ptf
...
sidp=0x00401030
id=11u
timestamp=1447854940u

# Include operating system specific parameters, if they are supplied.

if test -f /cygdrive/d/altera/11.0/nios2eds/components/micrium_uc_osii/build/os.sh ; then
   . /cygdrive/d/altera/11.0/nios2eds/components/micrium_uc_osii/build/os.sh
fi
