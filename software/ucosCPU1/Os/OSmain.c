...
unsigned long int * fifoWrData = (unsigned long int *)(FIFO1_IN_BASE);//写FIFO地址
unsigned long int * fifoRdData = (unsigned long int *)(FIFO1_OUT_BASE);//读FIFO地址
